...
CLI:
    python -m lib.midnight_magnates.diorama --scene s.json --out-html out.html --out-graph g.json
"""
...
DIORAMA_VERSION = "midnight_magnates.diorama@{0}".format(__version__)
DEFAULT_FPS = 12
DEFAULT_TILT = 55.0
...
def _main(argv: Optional[List[str]] = None) -> int:
    ap = argparse.ArgumentParser(prog="midnight_magnates.diorama")
