...
CLI:  python -m lib.midnight_magnates.voice_qa --project <dir>          (real backend)
      python -m lib.midnight_magnates.voice_qa --selftest               (stub loop + assertions)
"""
...
def _main(argv: Optional[List[str]] = None) -> int:
    ap = argparse.ArgumentParser(prog="midnight_magnates.voice_qa")
