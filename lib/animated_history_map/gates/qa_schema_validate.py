...
Reads (each optional except where a referenced path is asserted):
    <project>/artifacts/theme.json            -> animated_history_map_theme
    <project>/artifacts/geography.json        -> animated_history_map_geography
    <project>/artifacts/canonical_names.json  -> animated_history_map_canonical_names
    <project>/artifacts/storyboard/*.json     -> animated_history_map_storyboard
...
SINGLE_FILE_SCHEMAS: List[Tuple[str, str]] = [
    ("artifacts/theme.json", "animated_history_map_theme"),
    ("artifacts/geography.json", "animated_history_map_geography"),
    ("artifacts/canonical_names.json", "animated_history_map_canonical_names"),
]

# storyboard is one JSON per chapter under artifacts/storyboard/*.json
STORYBOARD_GLOB_DIR = "artifacts/storyboard"
STORYBOARD_SCHEMA = "animated_history_map_storyboard"
